...
class TestOptimization(TestCase):
    def test_gradient_descent_scalar(self):
        # argmin_x x * x = 0
        i, x, cost = run_iterations(gradient_descent_scalar(cost_function, derivative_function, 10.0, 0.1), 1000)
    ...
    def test_newtons_method_scalar(self):
        ...
        i, x, cost = run_iterations(newtons_method_scalar(cost_function, derivative_function, second_derivative_function, 10.0, 1.0), 1000)
